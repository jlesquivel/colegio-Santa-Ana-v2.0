...
Public Class rptGrafPagos2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "colegioReportes.rptGrafPagos2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGrafPagos2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGrafPagos2 = New rptGrafPagos2()
        rpt.Site = Me.Site
        Return rpt
    End Function
