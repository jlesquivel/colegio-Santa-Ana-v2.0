...
Public Class rptCobrosMontosSub
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "colegioReportes.rptCobrosMontosSub.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCobrosMontosSub
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCobrosMontosSub = New rptCobrosMontosSub()
        rpt.Site = Me.Site
        Return rpt
    End Function
