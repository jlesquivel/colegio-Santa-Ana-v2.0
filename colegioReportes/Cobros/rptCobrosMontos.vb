...
Public Class rptCobrosMontos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "colegioReportes.rptCobrosMontos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCobrosMontos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCobrosMontos = New rptCobrosMontos()
        rpt.Site = Me.Site
        Return rpt
    End Function
