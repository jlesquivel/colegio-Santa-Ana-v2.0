...
Public Class rptCobrosNota
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "colegioReportes.rptCobrosNota.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Adm() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptCobrosNota
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCobrosNota = New rptCobrosNota()
        rpt.Site = Me.Site
        Return rpt
    End Function
