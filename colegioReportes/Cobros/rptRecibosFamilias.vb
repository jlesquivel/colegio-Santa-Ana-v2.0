...
Public Class rptRecibosFamilias
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "colegioReportes.rptRecibosFamilias.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRecibosFamilias
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRecibosFamilias = New rptRecibosFamilias()
        rpt.Site = Me.Site
        Return rpt
    End Function
