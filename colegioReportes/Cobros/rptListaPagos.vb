...
Public Class rptListaPagos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "colegioReportes.rptListaPagos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListaPagos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListaPagos = New rptListaPagos()
        rpt.Site = Me.Site
        Return rpt
    End Function
