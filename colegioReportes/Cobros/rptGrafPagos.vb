...
Public Class rptGrafPagos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "colegioReportes.rptGrafPagos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGrafPagos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGrafPagos = New rptGrafPagos()
        rpt.Site = Me.Site
        Return rpt
    End Function
