...
Public Class rptCobrosMorososClaseMes
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCobrosMorososClaseMes.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "colegioReportes.rptCobrosMorososClaseMes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCobrosMorososClaseMes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCobrosMorososClaseMes = New rptCobrosMorososClaseMes()
        rpt.Site = Me.Site
        Return rpt
    End Function
