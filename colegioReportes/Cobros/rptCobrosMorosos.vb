...
Public Class rptCobrosMorosos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "colegioReportes.rptCobrosMorosos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCobrosMorosos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCobrosMorosos = New rptCobrosMorosos()
        rpt.Site = Me.Site
        Return rpt
    End Function
