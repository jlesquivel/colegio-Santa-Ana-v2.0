...
Public Class rptPolizasINS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "colegioReportes.rptPolizasINS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPolizasINS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPolizasINS = New rptPolizasINS()
        rpt.Site = Me.Site
        Return rpt
    End Function
