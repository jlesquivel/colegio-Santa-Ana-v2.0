...
Public Class rptFamiliasGrupo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "colegioReportes.rptFamiliasGrupo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFamiliasGrupo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFamiliasGrupo = New rptFamiliasGrupo()
        rpt.Site = Me.Site
        Return rpt
    End Function
