...
Public Class rptListaClaseAno2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "colegioReportes.rptListaClaseAno2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListaClaseAno2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListaClaseAno2 = New rptListaClaseAno2()
        rpt.Site = Me.Site
        Return rpt
    End Function
