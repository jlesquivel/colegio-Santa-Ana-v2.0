...
Public Class rptMatricula
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "colegioReportes.rptMatricula.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMatricula
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMatricula = New rptMatricula()
        rpt.Site = Me.Site
        Return rpt
    End Function
