...
Public Class rptListaClaseAno
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "colegioReportes.rptListaClaseAno.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListaClaseAno
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListaClaseAno = New rptListaClaseAno()
        rpt.Site = Me.Site
        Return rpt
    End Function
