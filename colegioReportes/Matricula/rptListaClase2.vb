...
Public Class rptListaClase2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "colegioReportes.rptListaClase2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListaClase2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListaClase2 = New rptListaClase2()
        rpt.Site = Me.Site
        Return rpt
    End Function
