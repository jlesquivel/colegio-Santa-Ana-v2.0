...
Public Class rptAusenciaEst
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "colegioReportes.rptAusenciaEst.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAusenciaEst
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAusenciaEst = New rptAusenciaEst()
        rpt.Site = Me.Site
        Return rpt
    End Function
