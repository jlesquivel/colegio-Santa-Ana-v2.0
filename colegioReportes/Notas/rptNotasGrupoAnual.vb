...
Public Class rptNotasGrupoAnual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "colegioReportes.rptNotasGrupoAnual.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNotasGrupoAnual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNotasGrupoAnual = New rptNotasGrupoAnual()
        rpt.Site = Me.Site
        Return rpt
    End Function
