...
Public Class rptAusenciasGrupo2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "colegioReportes.rptAusenciasGrupo2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAusenciasGrupo2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAusenciasGrupo2 = New rptAusenciasGrupo2()
        rpt.Site = Me.Site
        Return rpt
    End Function
