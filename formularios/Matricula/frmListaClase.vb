...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        '
        Me.Imprimir.Index = 1
        Me.Imprimir.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.MenuItem1, Me.MenuItem2, Me.MenuItem5, Me.MenuItem7, Me.MenuItem8, Me.MenuItem9, Me.MenuItem10, Me.MenuItem11, Me.MenuItem13})
    ...
    "urity info=False;workstation id=PORTATIL;packet size=4096"
        ...
        Me.DataGridTableStyle1.GridLineColor = System.Drawing.Color.Transparent
        ...
        'SqlInsertCommand2
        '
        Me.SqlInsertCommand2.CommandText = "INSERT INTO estudiantes(carnet, apellido1, apellido2, nombre) VALUES (@carnet, @a" &
    ...
    "D=sa;Password=123"
        ...
        'SqlInsertCommand1
        '
        Me.SqlInsertCommand1.CommandText = "INSERT INTO estudiantes(carnet, apellido1, apellido2, nombre) VALUES (@carnet, @a" &
    "pellido1, @apellido2, @nombre)"
        ...
        'SqlFamiliaApellidos
        '
        Me.SqlFamiliaApellidos.CommandText = "SELECT DISTINCT estudiantes.familia FROM matricula LEFT OUTER JOIN estudiantes ON" &
    " matricula.carnet = estudiantes.carnet WHERE (matricula.ano = @ano) ORDER BY est" &
    "udiantes.familia"
...
#End Region
    ...
    Private Sub MenuItem13_Click(sender As Object, e As EventArgs) Handles MenuItem13.Click
        ' reporte profesore guia
        Try
            Dim oImprimir As New Reportes
            Dim rep As New rptProfGuia
            oImprimir.inserta_parametro(rep, "@anno", partes(1))
            oImprimir.inserta_parametro(rep, "@periodo", 1)
            rep.SummaryInfo.ReportComments = "LISTA DE PROFESORES GUÍA"
            oImprimir.imprimir(rep, False, ParentForm)
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Imprimir",
            MessageBoxButtons.OK, MessageBoxIcon.Error)
