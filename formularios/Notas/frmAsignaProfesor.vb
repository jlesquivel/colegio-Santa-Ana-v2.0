...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'SqlConnection1
        '
        Me.SqlConnection1.ConnectionString = "workstation id=""EG-HPZE5547"";packet size=4096;user id=jose;data source=servidor_b" &
    ...
    "D;persist security info=False;initial catalog=planilla"
        ...
        'ActualizaProfesor
        '
        Me.ActualizaProfesor.CommandText = "UPDATE profesores_cursos SET cedula = @cedula WHERE (ano = @ano) AND (periodo = @" &
    "periodo) AND (nivel = @nivel) AND (grupo = @grupo) AND (materia = @materia)"
        ...
        Me.ListBox1.Size = New System.Drawing.Size(248, 414)
