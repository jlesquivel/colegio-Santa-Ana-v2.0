...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.CEstadoCuenta1.Location = New System.Drawing.Point(15, 19)
        Me.CEstadoCuenta1.Name = "CEstadoCuenta1"
        Me.CEstadoCuenta1.Size = New System.Drawing.Size(447, 256)
...
#End Region
    ...
    Public Property BuscarVisible() As Boolean
        ...
        Set(ByVal Value As Boolean)
            Bvisible = Value
            Me.BuscaEstudiante1.Visible = Bvisible
            Me.Refresh()
        End Set
    End Property
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Me.SqlDataAdapter1.Update(DataSet11, Me.bd)
    End Sub
    ...
    Public Sub guardar()
        Try
            If Not (PictureBox1.Image Is Nothing) Then
                Me.SqlDataAdapter2.SelectCommand.Parameters.Item("@carnet").Value = pcarnet
                Me.SqlDataAdapter2.Fill(DataSet11, "fotos")
            ...
            End If
            Me.BindingContext(DataSet11, Me.bd).EndCurrentEdit()
            Me.BindingContext(DataSet11, "fotos").EndCurrentEdit()

            SqlDataAdapter1.Update(DataSet11, Me.bd)
    ...
    Public Sub borrar()
        Try
            ...
            Registro = Me.BindingContext(DataSet11, Me.bd).Position
            Me.BindingContext(DataSet11, Me.bd).EndCurrentEdit()
            Me.BindingContext(DataSet11, Me.bd).RemoveAt(Registro)
            Me.SqlDataAdapter1.Update(DataSet11, Me.bd)
            PictureBox1.Image = Nothing
            Me.BindingContext(DataSet11, Me.bd).Position = 0
        Catch eEndEdit As System.Exception
            System.Windows.Forms.MessageBox.Show(eEndEdit.Message)
        End Try
    End Sub
    ...
    Public Sub buscar(ByVal pcarnet As String)
        ...
        If Not (pcarnet Is Nothing) Then
            ...
            Me.guardar()
            Me.DataSet11.Tables(Me.bd).Clear()
            Me.DataSet11.Tables("fotos").Clear()

            Me.SqlDataAdapter1.SelectCommand.Parameters.Item("@carnet").Value = pcarnet
            Me.SqlDataAdapter1.Fill(DataSet11, Me.bd)
            ...
            'CestadoCuenta
            Me.CEstadoCuenta1.buscar(pcarnet)
            Me.SuperTabItem5.PredefinedColor = eTabItemColor.Default

            If CEstadoCuenta1.pendiente Then
                Me.SuperTabItem5.PredefinedColor = eTabItemColor.Red
            End If
            'CNotasEstudiante
            Me.CNotasEstudiante1.buscar(pcarnet)
    ...
    Public Sub buscar()
        Try
            Me.BuscaEstudiante1.Visible = Not Bvisible
    ...
    Public Sub imprimir()
        Try
            ...
            Me.SqlDataAdapter1.Fill(mi_reporte, "estudiantes")
    ...
    Sub mostrar_imagen()
        If DataSet11.Tables("fotos").Rows.Count > 0 Then
            ...
            DataRowView1 = CType(Me.BindingContext(DataSet11, "fotos").Current, DataRowView)
    ...
    Private Sub TextBox3_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBox3.TextChanged
        Me.TextBox13.Text = Me.TextBox3.Text & Me.TextBox4.Text
    End Sub
    ...
    Private Sub BuscaEstudiante1_selecionado(ByVal sender As Object, ByVal e As SeleccionadoEventArgs) Handles BuscaEstudiante1.selecionado
        Me.buscar(Me.BuscaEstudiante1.seleccionado)
    End Sub
