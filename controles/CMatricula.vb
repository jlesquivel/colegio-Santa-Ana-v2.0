...
#End Region
    ...
    Sub limpia_controles()
        ...
        Me.matricula.Text = ""
        Me.bingo.Text = ""
        Me.MonedaTextBox2.Text = ""

        Me.ErrorProvider1.SetError(ComboBox1, "")
        Me.ErrorProvider1.SetError(ComboBox2, "")
        Me.ErrorProvider1.SetError(MonedaTextBox2, "")
    ...
    Private Sub CMatricula_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If Not Me.DesignMode Then
            ...
            conn.llena(Me.DsCuotas1, "cuotas", "Select * from cuotas")
        End If
    ...
    Public Sub guardar()
        Try
            ...
            afectadas = Me.SqlDataAdapter1.Update(DataSet21, "matricula")
            Me.limpia_controles()
        ...
        Try
            ...
            If val = 0 Then   ' en el caso de que NO se haya matriculado este ano
                ...
                If val <> 0 Then  ' si se matriculo anterior mente carga los datos anteriores
                    ...
                    Me.BindingContext(DataSet21.Tables("niveles")).Position += 1
                    r2 = regNiveles.Item(Me.BindingContext(DataSet21.Tables("niveles")).Position)

                    Dim Obind As BindingManagerBase = BindingContext(DataSet21.Tables("matricula"))

                    DataSet21.Tables("matricula").Clear()

                    Me.BindingContext(DataSet21.Tables("matricula")).AddNew()
                    ...
                    Me.BindingContext(DataSet21.Tables("matricula")).EndCurrentEdit()
                    Me.BindingContext(DataSet21.Tables("matricula")).ResumeBinding()
                Else
                    Dim Obind As BindingManagerBase = BindingContext(DataSet21.Tables("matricula"))
                    Me.BindingContext(DataSet21.Tables("matricula")).AddNew()
                    Dim nuevo As DataRowView = Obind.Current
                ...
                If Not (datosCobros Is Nothing) Then
                    If Not (datosCobros(0)(5) Is DBNull.Value) Then
                        Me.TextBox4.Text = datosCobros(0)(5)
                        Me.DateTimePicker1.Value = datosCobros(0)(6)
                        Me.MonedaTextBox2.Text = datosCobros(0)(7)
                    Else
                        Me.TextBox4.Text = ""
            ...
            Else
                If MsgBox("Ya esta Matriculado ,Desea modificar ?", MsgBoxStyle.YesNo) _
                    ...
                    Me.MonedaTextBox2.Text = noNull(regis.Item("bingo")) _
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        If (error_blanco(Me.ComboBox1) And error_blanco(Me.ComboBox2) And _
            error_blanco(Me.MonedaTextBox2) And error_blanco(Me.TextBox4)) Then
            Me.guardar()
            Me.Enabled = False
        End If
    End Sub
    ...
    Private Sub MonedaTextBox2_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MonedaTextBox2.Validating
        ...
        If IsNumeric(MonedaTextBox2.Text) Then
            ...
            Else
                ...
                Me.ErrorProvider1.SetError(MonedaTextBox2, "monto inferior al mínimo")
            End If
        Else
            e.Cancel = True
            Me.MonedaTextBox2.Text = 0
            Me.ErrorProvider1.SetError(MonedaTextBox2, "No es un valor")
        End If
